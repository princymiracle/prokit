  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar:AppBar(centerTitle: true,
        ...
        title: Text("Standart BottomSheet",style: TextStyle(color: Colors.white,fontSize: 20,fontWeight: FontWeight.w600),),
          ...
          children: [
            Padding(padding: EdgeInsets.only(top: 4.w,left: 5.w,right: 5.w),
              child: Column(
                ...
                children: [
                  Text("Standart BottomSheet",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 13.sp),),

                  Text("This is the example of standart of Bottom Sheet without any style",style: TextStyle(color: Colors.black54,fontSize: 11.sp),),
                  SizedBox(height: 2.h,),

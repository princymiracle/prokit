...
List<Widgetdata> widgetdata = [
  Widgetdata(color1: Color(0xff9888A5), img: "assets/icons/icon_saf1.png", title: "Without Safe Area", ),
  Widgetdata(color1: Color(0xffC0B298), img: "assets/icons/icon_saf2.png", title: "With Safe Area", ),
    ...
    return SafeArea(
      child: Scaffold(
        appBar: AppBar(
          ...
          title: Text("Safe Area Widget",style: TextStyle(fontSize: 15.sp,fontWeight: FontWeight.w900),),
          centerTitle: true,
        ),
        body: Padding(

                        ...
                        child:Container(
                          child: Column(crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              ...
                              SizedBox(height: 2.w,),
                              Text("Header", style: TextStyle(color: Colors.white,fontWeight: FontWeight.w600),),
                              Text("Header detail", style: TextStyle(color: Colors.white,fontWeight: FontWeight.w600),),
                            ],
                          ),
                        ),
                      ),

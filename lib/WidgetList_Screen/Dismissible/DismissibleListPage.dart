...
import '../AnimatedItem/AnimatedCrossFade/AnimatedCrossFade.dart';
...
//   String title;
//   DismissibleListPage({super.key,this.title = 'Dismissible Widget'});
//
//   List listData = [
//     "Dismissible 1 - standart",
//     "Dismissible 2 - Properties",
//   ];
//
//   @override
//   Widget build(BuildContext context) {
